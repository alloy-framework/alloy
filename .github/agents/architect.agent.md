...
1. `packages/core/docs/index.md` — index of all core conceptual guides.
2. `packages/core/docs/guides/language-package-guide.md` — the authoritative guide for language package design.
3. `packages/core/docs/guides/references-and-refkeys.md` — the symbol and reference system.

Also read as needed based on the task:

- `packages/core/docs/components.md` — component model, props, children, tagged children.
- `packages/core/docs/rendering.md` — render pipeline, tree structure, output files.
- `packages/core/docs/symbols-and-scopes.md` — declarations, references, binder, name policies.
- `packages/core/docs/formatting.md` — intrinsic elements, layout components, `code`/`text` tags.
- `packages/core/docs/reactivity.md` — reactive primitives, effects, memos, scheduling.
- `packages/core/docs/context.md` — dependency injection through the component tree.
- `packages/core/docs/guides/style-guide.md` — idiomatic patterns and conventions.
...
1. Follow the style guide (`packages/core/docs/guides/style-guide.md`).
