...
1. `packages/docs/src/content/docs/guides/diagnosing-issues.md` — the authoritative debugging guide with environment variables, CLI commands, common errors, and step-by-step workflows.
2. `packages/core/docs/debugging.md` — diagnostics API, trace files, and the `alloy-trace` CLI reference.

Also read as needed:

- `packages/core/docs/symbols-and-scopes.md` — for symbol resolution issues.
- `packages/core/docs/formatting.md` — for formatting/layout issues.
- `packages/core/docs/reactivity.md` — for reactive cycle or effect issues.
- `packages/core/docs/rendering.md` — for render pipeline issues.
- `packages/core/docs/guides/references-and-refkeys.md` — for refkey and cross-file reference issues.
- `packages/core/docs/guides/style-guide.md` — for Alloy JSX idioms and patterns.
