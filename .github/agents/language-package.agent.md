...
1. `packages/core/docs/guides/language-package-guide.md` — the authoritative guide for language package design, style, symbols, scopes, components, testing, formatting, and more.
2. `.github/copilot-instructions.md` — Alloy JSX syntax rules and component structure conventions.
