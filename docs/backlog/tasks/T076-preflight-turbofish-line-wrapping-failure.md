# T076 — Pre-flight turbofish line-wrapping failure in `FunctionCallExpression`
...
Mandatory pre-flight validation failed before task execution.
...
- `docs/backlog/tasks/T075-function-call-expression-turbofish-wrapping-mismatch.md`
