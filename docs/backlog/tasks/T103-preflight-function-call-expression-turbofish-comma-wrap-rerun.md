# T103 — Preflight FunctionCallExpression turbofish comma-wrap regression on rerun
...
The regression shows output as `f::<String,\nu32>(raw, 10);` when the expected rendering remains `f::<String, u32>(raw, 10);` on one line for this case.
...
- [ ] Task captures this pre-flight failure exactly, including command, failing test name, and turbofish comma-wrap behavior.
...
- `docs/backlog/tasks/T102-preflight-function-call-expression-turbofish-test-mismatch.md`
