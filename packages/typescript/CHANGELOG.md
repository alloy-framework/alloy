...
- [#379](https://github.com/alloy-framework/alloy/pull/379) Widen `tsNameConflictResolver` parameter type from `TSOutputSymbol[]` to `OutputSymbol[]` to match the `NameConflictResolver` interface.
